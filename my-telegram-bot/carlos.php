...
$Dev = array("$admin","$From_Dev");
$eri = array("1235694242", "1235694242" );
$sudo = $admin;
$DevUser = "@$UserDevpe";
...
$DRPP = "7459745711:AAHMW22z0WU5jxPd2RKBE4jQAopgx_zxhiM";
$ckl = "@Q_K_Q_Q"; 
...
file_put_contents("data/namebot.txt","الحجي");
...
$abuehab = array("هلا قلبي معاك ","تفضل حبيبي انا ","يمك حياتي امرني 🥺💞","شتريد كل شويه بوت","يابه نجب كل شويه بوت خبصتنه");
$ehab = array_rand($proxre, 1);
if($text == "بوتاتي" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
[['text'=>"⌔ مبرمج السورس ⁞✵",'url'=>"t.me/Q_K_Q_Q"]],
]])
]); 
}
if($data == "nd3" ){
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/botat_3"]],
]])
]); 
}
}
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙اوامر الحمايه سورس بوتاتي
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙قفل ، فتح ← الامر 
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙اوامر الاعضاء لسورس بوتاتي
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
...
[['text'=>"سورس بوتاتي.",'url'=>"https://t.me/botat_3"]],
]])]);}
$ex = explode("#",$data);
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- بوتاتي .",'url'=>"t.me/botat_3"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>"⌔ 𝙱𝙾𝚃 𝙳??𝚅 ⁞✵",'url'=>"t.me/Sguxbot"]],
[['text'=>"⌔ 𝙳𝙴𝚅 ⁞✵",'url'=>"Q_K_Q_Q"],['text'=>"⌔ 𝙲𝙷  ⁞✵",'url'=>"t.me/botat_3"]],
]])
]); 
}
############     
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"⋄︙قائمة ملفات متجر سورس بوتاتي
...
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙[𝘀𝗼𝘂𝗿𝗰𝗲](https://t.me/botat_3)
⋄︙[𝗰𝗹𝗮𝘀𝗵 𝗶𝗱](https://t.me/Q_K_Q_Q)
⋄︙[𝗳𝗲𝗹𝗶𝘀 𝘀𝗼𝘂𝗿𝗰𝗲](https://t.me/botat_3)
⋄︙[𝘂𝗽𝗱𝗮𝘁𝗲 𝘀𝗼𝘂𝗿𝗰𝗲](https://t.me/botat_3)
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙[𝗱𝗲𝘃 𝘀𝗼𝘂𝗿𝗰𝗲](https://Q_K_Q_Q)
",'parse_mode'=>"Markdown",
'disable_web_page_preview'=> true ,
'reply_to_message_id'=>$message_id,
]); 
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"⌔ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ [كروب تجربة السورس](https://t.me/botat_3)\n⌯⁞ [قناة شروحات السورس](https://t.me/botat_3)\n━━━━━━━━━━━━━\n⌯⁞ [مطور السورس](https://Q_K_Q_Q)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ كروب تجربة السورس ⁞⌯",'url'=>"t.me/botat_3"]],[['text'=>"⌯⁞ مطور السورس ⁞⌯",'url'=>"Q_K_Q_Q"]],]])]);}}
#######
...
⋄︙تغير الايدي ↫ تغ
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
[سورس بوتاتي](https://t.me/botat_3)",
'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,
 ]);
 } 
 #---------------#
